...
prepareSevenSegmentDisplayQueue:
    ...
    decimalPlaceLoop:
        ...
        if_DigitIsZero: 
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #00000000 00000000 00000000 00000000
            b decimalPlaceLoop
            
        if_DigitIsOne:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #01100000 00000000 00000000 00000000
            b decimalPlaceLoop
            
        if_DigitIsTwo:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #11011010 00000000 00000000 00000000
            b decimalPlaceLoop

        if_DigitIsThree:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #11110010 00000000 00000000 00000000
            b decimalPlaceLoop

        if_DigitIsFour:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #01110110 00000000 00000000 00000000
            b decimalPlaceLoop

        if_DigitIsFive:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #10110110 00000000 00000000 00000000
            b decimalPlaceLoop

        if_DigitIsSix:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #10111110 00000000 00000000 00000000
            b decimalPlaceLoop
            
        if_DigitIsSeven:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #11100000 00000000 00000000 00000000
            b decimalPlaceLoop
            
        if_DigitIsEight:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #11111110 00000000 00000000 00000000
            b decimalPlaceLoop
            
        if_DigitIsNine:
            asr r2, r2, #8
            and r2, r2, #00000000 11111111 11111111 11111111
            orr r2, r2, #11110110 00000000 00000000 00000000
            b decimalPlaceLoop

    end_prepareSevenSegmentDisplayQueue:
        ldr lr, [sp], #+8
        bx      lr    decimalPlaceLoop:
